...
<form method="post" action="15 newcustomer2.php">
	
	<input type="text" name="firstname" placeholder="Forename" class="inp-control" required>
	</br>
	<input type="text" name="lastname" placeholder="Surname" class="inp-control" required>
	</br>
	<input type="text" name="email" placeholder="Email Address" class="inp-control" >
	</br>
	<input type="text" name="phone" placeholder="Contact Number" class="inp-control" required>
	</br>
	<input type="text" name="add1" placeholder="House Number + Street" class="inp-control" required>
	</br>
	<input type="text" name="add2" placeholder="City" class="inp-control" required>
	</br>
	<input type="text" name="add3" placeholder="County" class="inp-control" >
	</br>
	<input type="text" name="add4" placeholder="Postcode" class="inp-control" required>
	</br>
	</br>
