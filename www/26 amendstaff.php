...
<div>
	<h2>Search for Staff Member to Amend:</h2>
</div>
		
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	
	<form name='amend' method='post' action="26 amendstaff.php">
	
	<div id="search_container">
		<input type="text" name="staff" id="staff" autocomplete="off" class="form-control">
   		<div id="results"></div>
	</div>
...
<div><input type = submit value = 'Select Staff Member' class='sub-control'></div>
	</br>
</form>	
...
<?PHP
	...
	if (isset($_POST['StaffID'])){
		...
		echo("<form name='amend' method='post' action='28 amendstaff2.php'>");
		...
		echo("
				...
				<input type='text' name='fname' placeholder='First Name' class='inp-control' value='$fname' required>
				</br>
				<input type='text' name='sname' placeholder='Last Name' class='inp-control' value='$sname' required>
				</br>
				<input type='text' name='uname' placeholder='Username' class='inp-control' value='$uname' required>
				</br>
				<input type='text' name='pay' placeholder='Payroll Number' class='inp-control' value='$pay' required>
				</br>
				<input type='text' name='access' placeholder='Access' class='inp-control' value='$access' required>
				</br>
