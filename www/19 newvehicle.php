...
<h2>Enter New Vehicle Details:</h2>
...
<form method="post" action="20 newvehicle2.php">
	
	<input type="text" name="make" placeholder="Make" class="inp-control" required>
	</br>
	<input type="text" name="model" placeholder="Model" class="inp-control" required>
	</br>
	<input type="text" name="reg" placeholder="Registration" class="inp-control" required>
	</br>
	<input type="text" name="colour" placeholder="Colour" class="inp-control" required>
	</br>
	<input type="text" name="cost" placeholder="Rental Cost (£)" class="inp-control" required>
	</br>
	</br>
